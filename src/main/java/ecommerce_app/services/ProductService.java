...
public class ProductService {
    ...
    public Optional<List<ProductDet>> getProducts(String name){
        return productRepository.findByName(name);
    }

    public Optional<ProductDet> getProductsById(String id){
        return productRepository.findById(id);
    }


    public boolean addNewProduct(ProductDet product){
